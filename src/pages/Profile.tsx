  ...
  return (
    <div className="min-h-screen bg-[var(--bg)]">
      <div className="max-w-md mx-auto px-4 py-6">
        ...
        <form onSubmit={handleSave} className="space-y-4 bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
          <div>
        ...
        <div className="mt-6 p-5 rounded-2xl border border-[var(--border)] bg-[var(--bg-card)] shadow-sm hover:shadow-md transition-shadow">
